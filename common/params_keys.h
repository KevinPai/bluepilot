...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"FordStockAccStopGoV12", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordStockAccGoReleaseV14", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordStockAccSoftCrawlObserve", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"FordStockAccSoftCrawlControl", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordStockAccSoftCrawlV16", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordStockAccSoftCrawlV17", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordStockAccSoftCrawlV171", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordStockAccSoftCrawlV172", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"FordLongitudinalGap", {PERSISTENT | BACKUP, INT, "3"}},
